...
**Explicitly NOT short-term:** accounts/save/history (Slice 2, once repeat use is visible) · institutional workspace · extension. The dispute/flag *intake* shipped first; the *review workflow* (expert review queue) has since shipped too (**expert-review-queue** — see §5/§7 and the debt ledger).
...
| Phase | Focus |
|---|---|
| **Pilots** | ~~Normalize the report graph (§7)~~ **done** · ~~observability before pilots (§7)~~ **done** · ~~expert review queue UI~~ **done (expert-review-queue)** · institutional workspace (shared collections, classroom annotation) · accounts/save/history · EN/NL localization · EDMO/BENEDMO outreach for the human-review layer via partnership, not payroll |

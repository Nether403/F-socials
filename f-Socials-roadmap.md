...
| Phase | Focus |
|---|---|
| **Pilots** | ~~Normalize the report graph (§7)~~ **done** · ~~observability before pilots (§7)~~ **done** · expert review queue UI · institutional workspace (shared collections, classroom annotation) · accounts/save/history · EN/NL localization · EDMO/BENEDMO outreach for the human-review layer via partnership, not payroll |
